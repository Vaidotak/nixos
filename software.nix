...

{
  environment.systemPackages = with pkgs; [
    ...
    clipman # Iškarpinės tvarkyklė
    i3-gaps # I3 Window Manager su atstumais
    i3status # I3 Window Manager statusas
    alacritty # Greita terminalo emuliacija
    pavucontrol # Garso valdymas
    alsa-utils # ALSA garso įrankiai
    i3blocks-gaps # I3 Window Manager blokai su atstumais
    i3lock # I3 Window Manager užraktas
